				...
				<div className="container my-5">
					<div className="row">
						<div className="col-md-3">
							...
							/>
							<p>
								INSPIRE RESUME is organize & managed by the INSPIRE team. The
								purpose is to provide an extremely rich graphical user interface
						...
						<div className="col-md-3">
							...
							<p>
								...
								<a
									className="footer-link"
									href="mailto:info.inspirecg@gmail.com"
								>
					...
					{/* <Grid container>
						<Grid item xs={12} sm={6} md={3} className="footer-col">
							<h6 style={{ margin: "6px 6px 6px 0" }}>Inspire Resume</h6>
							<br />
